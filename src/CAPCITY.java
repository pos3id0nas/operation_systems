...
public class CAPCITY extends JFrame {
    ...
    public void CAPACITYFUNC(){
        try {
            ...
            l9 = new JLabel("\nTHE PAGE CAPASITY IS  2^"+LOGHD+"   /  2^"+LOGOS +"             : 2^"+PAGE);
            l9.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l9.setForeground(Color.white);
            l9.setBounds(100, 50, 700, 30);
            l8 = new JLabel("--------------------------------------------------------------------------------------------------\n");
            l8.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l8.setForeground(Color.white);
            l8.setBounds(100, 70, 700, 30);
            l2 = new JLabel("FOR : 2 GB THE TOTAL PER CENTAGE IS       : " + LIMIT[0]);
            l2.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l2.setForeground(Color.white);
            l2.setBounds(100, 90, 700, 30);
            l3 = new JLabel("FOR : 4 GB THE TOTAL PER CENTAGE IS       : " + LIMIT[1]);
            l3.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l3.setForeground(Color.white);
            l3.setBounds(100, 110, 700, 30);
            l4 = new JLabel("FOR : 8 GB THE TOTAL PER CENTAGE IS       : " + LIMIT[2]);
            l4.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l4.setForeground(Color.white);
            l4.setBounds(100, 130, 700, 30);
            l5 = new JLabel("FOR : 16 GB THE TOTAL PER CENTAGE IS     : " + LIMIT[3]);
            l5.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l5.setForeground(Color.white);
            l5.setBounds(100, 150, 700, 30);
            l6 = new JLabel("FOR : 32 GB THE TOTAL PER CENTAGE IS     : " + LIMIT[4]);
            l6.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l6.setForeground(Color.white);
            l6.setBounds(100, 170, 700, 30);
            l7 = new JLabel("FOR : 64 GB THE TOTAL PER CENTAGE IS     : " + LIMIT[5]);
            l7.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l7.setForeground(Color.white);
            l7.setBounds(100, 190, 700, 30);
            l10 = new JLabel("FOR : 128 GB THE TOTAL PER CENTAGE IS   : " + LIMIT[5]);
            l10.setFont(new Font("Book Antiqua", Font.BOLD, 18));
            l10.setForeground(Color.white);
            l10.setBounds(100, 210, 700, 30);
            f.add(l1);
            f.add(l9);
            f.add(l8);
            f.add(l2);
